...
namespace DOCSAN.INFRASTRUCTURE
{
    ...
    public class DapperRepository : IDisposable
    {
        ...
        private const string MasterConnectionStringName = "MasterConnection";
        ...
        {
            CreateSqlConnection(pConnectionString);
        }

        public IDbConnection CreateMasterConnection(IConfiguration configuration)
        {
            return new SqlConnection(configuration.GetConnectionString(MasterConnectionStringName));
        }
        /// <summary>
        ...
        private void CreateSqlConnection(string pConnectionString)
        {
            this.Connection = new SqlConnection(pConnectionString);
        }
        /// <summary>
        ...
        private T Invoke<T>(Func<T> pFunction, string sql, dynamic param = null)
        {
            ...
            {
                throw new Exception();
                //throw new DatabaseException(ex.Data["SqlState"], ex.Message, ex.Data["ColumnName"]);
            }
            finally
            {
